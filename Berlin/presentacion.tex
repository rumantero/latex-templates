...
\title[El problema de existencia y regularidad para las ecuaciones de Navier-Stokes]{El problema de existencia y regularidad para las ecuaciones de Navier-Stokes: uno de los siete problemas del milenio}  
\author[Nicolás Bourbaki]{Nicolás Bourbaki}
\institute[]{%
  Departamento de Matemáticas\\
  Universidad de Antioquia}
\date[Marzo, 2008]{Copyleft \copyright{} 2008. Reproducción permitida bajo los \\

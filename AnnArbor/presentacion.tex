...
\begin{document}
\title[El problema de existencia y \ldots ]{El problema de existencia y regularidad para las ecuaciones de Navier-Stokes: uno de los siete problemas del milenio}  
